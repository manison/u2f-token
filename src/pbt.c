...
#define PBT_PIN   5
#endif 
#define GPIO_PBT_RD    PBT_PIN
#define GPIO_PBT_BASE__(port) GPIO ## port ## _BASE
#define GPIO_PBT_BASE_(port) GPIO_PBT_BASE__(port)
#define GPIO_PBT_BASE  GPIO_PBT_BASE_(PBT_PORT)
